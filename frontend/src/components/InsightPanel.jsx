    ...
    <div className="glass p-4 space-y-3">
      ...
      {insight && (
        <div className="text-sm space-y-1">
          ...
          <p><b>Prediction (next point):</b> {insight.prediction?.toFixed?.(2)}</p>
          <p><b>Top Category:</b> {insight.top_category ? `${insight.top_category.category} (${insight.top_category.value.toFixed(2)})` : 'N/A'}</p>
